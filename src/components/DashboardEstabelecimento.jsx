...
function DashboardEstabelecimento() {
  ...
  if (!user) {
    return <p className="text-center text-gray-500">Carregando Gerenciamento...</p>;
  }
    ...
    <div className="min-h-screen flex flex-col bg-gray-100 font-sans">
      <div className="flex flex-grow">
        ...
        <aside className="w-64 bg-[#4d4d4d] text-white p-4 flex flex-col shadow-lg">
          <h2 className="text-xl font-bold mb-6 text-gray-100">Menu Estabelecimento</h2>
          <nav className="flex flex-col gap-4">
            <button
              onClick={() => navigate('/feedestabelecimento')}
        ...
        <main className="flex-grow bg-white p-6 shadow-inner flex flex-col">
          ...
          <div className="flex-grow bg-gray-50 rounded-lg shadow p-6">
            ...
            <p className="text-gray-700 mb-2">
              Aqui você pode gerenciar seus pedidos, motoboys e visualizar
              estatísticas do seu estabelecimento.
            </p>
          </div>
        </main>
      </div>
